...
// import React, { useState } from "react";
// import "../../styles/Quiz.css";
// import { useOpenAITTS } from "../../hooks/useTextSpeaker"; // updated hook
...
//   // Speak formatted question
//   const speakQuestion = () => {
//     const textToSpeak = displayedText.replace(/^Q\.\s*/i, ""); // remove "Q." if present
//     speaking ? stopSpeaking() : speakText(`Question: ${textToSpeak}`);
//   };
