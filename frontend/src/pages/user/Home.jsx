...
const Home = () => {
  ...
  // ✅ Start quiz session and reset points
  const startQuiz = async () => {
    try {
      ...
      // Save sessionId in localStorage to pass to QuizWrapper or ResultsPage
      localStorage.setItem("sessionId", sessionId);

      // Reset team points
      await resetTeamPoints();
    } catch (err) {
        ...
        <section className="main-container">
          <div className="home-content">
            ...
            <NavLink
              ...
              className="nav-link"
              onClick={startQuiz} // start quiz session when clicked
            >
